...
The first independent PAYF cafe operating under TRJFP banner opened in Armley, Leeds on December 16th 
2013.^[The first
...
first independent cafe was set-up shortly after AS returned home to his
home-town in Leeds.]
For the first 4 months this cafe
...
customers and other visitors. This allowed the cafe to shift from being a
small operation to opening 7 days per week full-time, within the space of a
couple of months.

The second cafe was a local community centre.
...
wanting to set-up similar cafes. Enthusistic responses to the cafe
from the general public, who visited the Armley cafe in increasing numbers
throughout 2013, also contributed to increased media attention.

Of the cafes to open outside Leeds, the largest in terms of output
...
more than 40 cafes directly or indirectly linked (via correspondence with
