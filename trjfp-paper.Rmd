...
As of ... 2015 TRJFP is also a legal entity, a Charitable Foundation
based in Leeds, UK but with operations worldwide (Figure 1).
The highest density of TRJFP cafes and enquiries surrounds its starting point
in West Yorkshire (Figure 2). T

!!! Figure of cafes worldwide
...
outlet-by-outlet bases. Running costs in a typical PAYF cafe are the same as
running costs in a conventional cafe, involving st
...
effectively tackled by food
policies, of the type advocated by [@Lang2004]? TRJFP cannot answer
all these
questions, which relate to wider questions about how to ensure equity and
health within a capitalist system [@Jackson2009a].
Indeed, some question the economy's sustainability overall
[@Ehrlich2013; @Martinez-Alier2010].
What TRJFP can do, however, is empower people to take participative
and community-led action to improve
the food system. The ride-ranging benefits demonstrated
in this paper are only the tip of the iceberg in terms of what is possible
for bottom-up food movements such as TRJFP. However, the problems in the
food system that TRJFP highlights and addresses are entrenched and 'systemic'
[@Beddoe2009]. This means that more structural changes,
of type set-out by [@Lang2004],  are required to reduce
food wastage, maldistribution and poor nutrition to levels that are
compatible with long-term economic, social and environmental sustainability.
